 ...
 * @author Home
 */
public class InvoiceDeatils extends javax.swing.JDialog {

    /**
     * Creates new form InvoiceDeatils
     */
    public InvoiceDeatils(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        loadCustomers();
    ...
    public void loadCustomers() {
        ...
        String inId = jLabel12.getText();

        try {
            ResultSet rs = MySQL.search("SELECT * FROM `invoice_item` WHERE `invoice_item`.`invoice_id`='" + inId + "' ORDER BY `invoice_item`.`id` ASC;");
            ...
            while (rs.next()) {
                ...
                v.add(rs.getString("invoice_item.name"));
                v.add(rs.getString("invoice_item.qty"));
                v.add(rs.getString("invoice_item.total"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InvoiceDeatils.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                InvoiceDeatils dialog = new InvoiceDeatils(new javax.swing.JFrame(), true);
