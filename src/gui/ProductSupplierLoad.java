 ...
 * @author Home
 */
public class ProductSupplierLoad extends javax.swing.JDialog {

    /**
     * Creates new form ProductSupplierLoad
     */
    public ProductSupplierLoad(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProductSupplierLoad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ProductSupplierLoad dialog = new ProductSupplierLoad(new javax.swing.JFrame(), true);
