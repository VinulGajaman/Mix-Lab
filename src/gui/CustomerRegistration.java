...
public class CustomerRegistration extends javax.swing.JPanel {
    ...
    public static void loadCustomers() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                v.add(rs.getString("customer.description"));
    ...
    public void loadCustomers(String text) {
        ...
        try {
            ResultSet rs = MySQL.search("SELECT * FROM `customer` WHERE `customer`.`name` LIKE '" + text + "%'  OR `customer`.`mobile` LIKE '" + text + "%' ORDER BY `customer`.id ASC;");
            DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
            dtm.setRowCount(0);
    ...
    private void initComponents() {
        ...
        jButton1.setText("   Register Customers");
        ...
        jTextField1.setText("Search Customer by Name or Mobile Number..........");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        if (evt.getClickCount() == 2) {
            ...
            CustomerUpdate cu = new CustomerUpdate(null, true);
            ...
            if (r == -1) {
                ...
                cu.jLabel8.setText(cid);
                cu.jTextField1.setText(name);
                cu.jTextField2.setText(number);
                cu.jTextArea1.setText(desription);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        RegisterCustomers rc = new RegisterCustomers(null, true);
        rc.setVisible(true);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jTextField1FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField1FocusGained
        // TODO add your handling code here:
        if (jTextField1.getText().equals("Search Customer by Name or Mobile Number..........")) {
            jTextField1.setText("");
